...
- Then you can add this Variable to your Agent's Blackboard by going to the **Blackboard Tab**, select the Variable type, give it a name and then click the **Create** button:
	![center|400](../../Attachments/UtilityIntelligence/Documentation/UtilityAgent/Blackboard/add-variable.png)
...
![reference-variable.png](../../Attachments/UtilityIntelligence/Documentation/UtilityAgent/Blackboard/reference-variable.png)
