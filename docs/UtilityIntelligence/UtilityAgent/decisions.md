...
![center|550](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Decisions/decision-weight.png)

You can change the weight of a decision in the **Decision Editor**:

![adjust-decision-weight](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Decisions/adjust-decision-weight.png)
...
![decisions-per-target](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Decisions/decisions-per-target.png)
...
![center](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Decisions/create-decision.png)
