...
# Creating a new Decision Maker

To create a new Decision Maker, you need to go to the **Agent Tab**, give the new Decision Maker a name, and then click the **Create** button:
