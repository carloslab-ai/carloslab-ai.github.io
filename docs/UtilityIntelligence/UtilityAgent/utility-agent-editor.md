...
![JSONEditing](../../Attachments/UtilityIntelligence/Animations/JSONEditing.gif)
...
![agent-tab](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/UtilityAgentEditor/agent-tab.png)
...
![StatusPreview](../../Attachments/UtilityIntelligence/Animations/StatusPreview.gif)
...
![RuntimeStatus](../../Attachments/UtilityIntelligence/Animations/RuntimeStatus.gif)

### Runtime Editing

Moreover, you can modify AI behavior during runtime for testing purposes without needing to replay the game.

![RuntimeEditing](../../Attachments/UtilityIntelligence/Animations/RuntimeEditing.gif)
...
![ConsiderationEditor](../../Attachments/UtilityIntelligence/Animations/ConsiderationEditor.gif)
...
![BlackboardVariables](../../Attachments/UtilityIntelligence/Animations/BlackboardVariables.gif)
