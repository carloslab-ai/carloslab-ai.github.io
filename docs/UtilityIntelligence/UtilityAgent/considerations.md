...
![center](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/infinite-axis.png)
...
![center|600](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/create-consideration.png)
...
![input-source](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/Inputs/input-source.png)
...
![center|400](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/UtilityAgentEditor/input-tab.png)

To select the input for a consideration, you need to select the input name from this drop down in **Consideration Editor**:  

![center|600](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/Inputs/select-input.png)
...
- To select the input normalization for a consideration, you need to select the normalization type from this drop down in **Consideration Editor**:  
	![center|600](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/Inputs/select-normalization.png)
...
![center|600](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Considerations/response-curves.png)
