...
![actions-execution-mode](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/ActionTasks/actions-execution-mode.png)
...
![max-repeat-count](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/ActionTasks/max-repeat-count.png)
...
![keep-running-until-finished](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/ActionTasks/keep-running-until-finished.png)
...
![assign-action-task](../../Attachments/UtilityIntelligence/Documenntation/UtilityAgent/Decisions/assign-action-task.png)
