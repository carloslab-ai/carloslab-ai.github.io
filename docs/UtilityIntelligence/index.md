...
## Getting Started
1. Firstly, you need to create a [ > Utility Agent Asset](.md#Utility%20Agent%20Asset) by right-clicking in **Project Window** and choosing **Create/CarlosLab/Utility Agent Asset**.
...
1. Add [ > Utility Agent Owner](.md#Utility%20Agent%20Owner) component to all of your Agents.
2. Drag & Drop the new Utility Agent Asset to the **Agent Asset** field of **Utility Agent Asset Owner**.

1. Add [ > Utility Entity Owner](.md#Utility%20Entity%20Owner) to all the entities that your agents want to interact with.

1. Create a [ > Utility World Owner](.md#Utility%20World%20Owner) GameObject by right-clicking in **Hierarchy Window** then choose **CarlosLab/Utility World Owner**
