...
![[Attachments/create-utility-agent-asset.png|Attachments/create-utility-agent-asset.png]]
...
![[Attachments/utility-intelligence-editor.png|Attachments/utility-intelligence-editor.png]]
...
![[Attachments/utility-agent-owner.png|Attachments/utility-agent-owner.png]]

1. Add [[#Utility Entity Owner| > Utility Entity Owner]] to all the entities that your agents want to interact with.
![[Attachments/utility-entity-owner.png|Attachments/utility-entity-owner.png]]
...
![[Attachments/create-utility-world-owner.png|Attachments/create-utility-world-owner.png]]
