...
A Utility Agent is a special [[utility-entity|Utility Entity]] that helps your AI make the right decision based on the current situation and controls it to perform the [[action-tasks|Action Tasks]] attached to the chosen decision.

[[action-tasks|Action Tasks]]
[[target-filters|target-filters]]
[[utility-entity|utility-entity]]
[[utility-world|utility-world]]
