...
A Utility Entity represents an object inside a [Utility World](UtilityWorld/index.md), and only Utility Entities in the same world can interact with each other. Therefore, if you want a GameObject to be the target of a [Utility Agent](../UtilityAgent/index.md), you need to do the following:
