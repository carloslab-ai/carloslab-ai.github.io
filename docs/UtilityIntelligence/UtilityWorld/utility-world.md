...
1. Handling the decision-making process of all [[utility-agent|Utility Agents]] inside the world.
3. Running the task associated with the chosen decision for all [[utility-agent|Utility Agents]]  inside the world.
